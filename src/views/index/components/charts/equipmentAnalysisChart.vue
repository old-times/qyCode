<template>
  <div class="equipmentAnalysisContain">
    ...
    <ul class="baseInfo">
      <li v-for="(item, index) in equipmentAnalysis" :key="index">
        <div class="left">
...
export default {
  ...
  data() {
    return {
      ...
      chart: null,
      imgList: [
        require("@/assets/left/icon_zcgl_1.png"),
        require("@/assets/left/icon_zcgl_2.png"),
        require("@/assets/left/icon_zcgl_3.png"),
      ],
    };
  },
  watch: {
  ...
  methods: {
    ...
    initEchart() {
      if (!this.chart) {
        this.chart = echarts.init(this.$refs.equipmentAnalysis);
      }
    },
    //问题版本分布
    initData() {
