<template>
  <div class="center">
    <div class="left1">
          ...
          <dl class="m-tablebox" style="height: 294px;">
            <dt class="m-tablebox-list m-tablebox-hd">
              <div
                ...
                style="width:25%;"
                v-for="(item, index) in businessInvestmentList.titles"
                :key="index"
              >
                {{ item }}
              </div>
            ...
            <div class="m-tablebox-inner">
              ...
              <dd
                ...
                v-for="(item, index) in businessInvestmentList.vals"
                :key="index"
              >
      ...
      <div class="m-2">
        ...
        <div class="g-w100" style="height:110px; display: flex; justify-content: center;">
          <div
            class="m-car2"
            v-for="(item, index) in investmentTrend"
            :key="index"
          >
            <div class="u-car-icon">
              <img :src="item.img" alt="" />
    ...
    <div class="center1" style="position: relative;margin:0 auto">
      <div class="m-menu">
    ...
    <div class="right1">
      <!-- 服务面积 -->
      <div class="right1-wrap">
        <div class="right1-box">
          <img
            src="../../../assets/right/house.png"
            alt=""
            style="width:46px;height:50px;margin-right:36px"
          />
          作业方式
        </div>
        <HouseTitle
      ...
      <div class="m-2" style="position: relative;">
        <HouseTitle
          style="margin-top:35px;position: absolute;top:-40px "
        ></HouseTitle>
        <el-button-group class="m-btnGroup">
          ...
          >
            ...
            <span style="margin-left:20px" v-if="index !== 2">/</span>
          </el-button>
        </el-button-group>
        <!-- 实时车辆 -->
  ...
  /deep/.el-button-group {
    ...
    .el-button {
      ...
      &.active {
        ...
        .text {
          text-shadow: 0 3px rgba(8, 71, 121), 2px 2px 18px rgba(255, 255, 255);
        }
      }
    }
  }
