<template>
  <div class="relative">
    <div id="caseLine111" :style="{ height: height, width: width }" />
  </div>
</template>
...
export default {
  ...
  methods: {
    initChart() {
      this.chart = echarts.init(this.$el.querySelector('#caseLine111'))
    ...
    fetchData() {
      let res = this.$datautils.getData("全国业务板块/人流统计分析", "折线图");
      console.log(res[0].vals, "人流统计分析")
      // const months = []
      // const jcls = []
      // const jccs = []
      // if (res[0].vals) {
